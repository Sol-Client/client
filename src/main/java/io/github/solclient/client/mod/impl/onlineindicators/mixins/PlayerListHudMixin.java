...
package io.github.solclient.client.mod.impl.onlineindicators.mixins;
...
public abstract class PlayerListHudMixin {
	...
	public void preBatch(int width, Scoreboard scoreboard, ScoreboardObjective playerListScoreboardObjective,
		...
		if (CoreMod.instance.onlineIndicator)
			OnlineIndicatorsMod.instance.fetch(client.player.networkHandler.getPlayerList().stream()
	...
	public int renderIcon(TextRenderer instance, String string, float x, float y, int colour) {
		...
		if (CoreMod.instance.onlineIndicator
				&& OnlineIndicatorsMod.instance.recall(sc$entry.getProfile().getId())) {
