...
public abstract class V1_7VisualsModMixins {
	...
	public static class DebugHudMixin {
		...
		public void render(Window window, CallbackInfo callback) {
			...
			String allocatedString = String.format("Allocated memory: %d%% (%dMB)", total * 100 / max, total / 1024 / 1024);
			text.drawWithShadow(allocatedString, window.getWidth() - text.getStringWidth(allocatedString), 12, 0xE0E0E0);
		}
