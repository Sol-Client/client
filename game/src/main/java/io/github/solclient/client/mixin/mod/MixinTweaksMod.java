...
public class MixinTweaksMod {
				...
				if (remainingHighlightTicks > 0 && highlightingItemStack != null) {
					...
					if (opacity > 0) {
						...
						for (String line : lines) {
							...
							getFontRenderer().drawStringWithShadow(line, x, y, 16777215 + (opacity << 24));
							y += height;
						}
	...
	public static abstract class MixinInventoryEffectRenderer extends GuiContainer {
		...
		@Redirect(method = "drawActivePotionEffects", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/resources/I18n;format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;"))
		public String overrideLevel(String translateKey, Object[] parameters) {
			if (TweaksMod.enabled && TweaksMod.instance.arabicNumerals
					&& translateKey.startsWith("enchantment.level.")) {
	...
	public static class MixinItemPotion {
		...
		@Redirect(method = "addInformation", at = @At(value = "INVOKE", target = "Lnet/minecraft/util/StatCollector;translateToLocal(Ljava/lang/String;)Ljava/lang/String;", ordinal = 1))
	...
	public static class MixinGuiIngameMenu {
		...
		public void overrideButton(GuiButton button, CallbackInfo callback) {
			if (button.id == 1 && !disconnect) {
				callback.cancel();
				button.displayString = EnumChatFormatting.GREEN
						+ I18n.format("sol_client.mod.tweaks.confirm_disconnect");
				disconnect = true;
			}
		}
