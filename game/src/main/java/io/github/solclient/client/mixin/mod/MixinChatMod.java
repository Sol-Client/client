...
public class MixinChatMod {
	...
	public static class MixinGuiScreen {
		...
		@Redirect(method = "handleComponentClick", at = @At(value = "FIELD", target = "Lnet/minecraft/client/settings/GameSettings;chatLinks:Z"))
		...
		@Redirect(method = "handleComponentClick", at = @At(value = "FIELD", target = "Lnet/minecraft/client/settings/GameSettings;chatLinksPrompt:Z"))
	...
	public static class MixinGameSettings {
		...
		@Redirect(method = "sendSettingsToServer", at = @At(value = "FIELD", target = "Lnet/minecraft/client/settings/GameSettings;chatColours:Z"))
	...
	public static class MixinGuiNewChat {
		...
		@Redirect(method = "getChatHeight", at = @At(value = "FIELD", target = "Lnet/minecraft/client/settings/GameSettings;chatHeightFocused:F"))
		...
		@Redirect(method = "getChatHeight", at = @At(value = "FIELD", target = "Lnet/minecraft/client/settings/GameSettings;chatHeightUnfocused:F"))
		...
		public void replaceGui(CallbackInfo callback) {
			if (ChatMod.enabled) {
				buttonList.add(new GuiOptionButton(GameSettings.Options.REDUCED_DEBUG_INFO.returnEnumOrdinal(),
						this.width / 2 - (150 / 2), this.height / 6 + 76, GameSettings.Options.REDUCED_DEBUG_INFO,
						game_settings.getKeyBinding(GameSettings.Options.REDUCED_DEBUG_INFO)));
				buttonList.add(new GuiButton(201, this.width / 2 - (150 / 2), this.height / 6 + 98, 150, 20,
						"More Options..."));
				buttonList.add(new GuiButton(200, this.width / 2 - (150 / 2), this.height / 6 + 120, 150, 20,
