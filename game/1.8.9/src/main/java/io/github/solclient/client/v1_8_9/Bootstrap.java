...
import io.github.solclient.client.v1_8_9.transformers.ExtensibleScreenTransformer;
...
public class Bootstrap {
	...
	public static void init(WrapperClassLoader loader) {
		...
		WrapperClassLoader.INSTANCE.registerTransformer(new ExtensibleScreenTransformer());
	}
