...
import io.github.solclient.client.mixin.client.MixinModelBakery;
import io.github.solclient.client.mixin.client.MixinModelBlock;
import io.github.solclient.client.mixin.client.MixinRenderItem;
...
class Util {
	...
	private void renderBakedModel(IBakedModel model) {
		...
		float rotation = 0.0f;
		float transform = model.getItemCameraTransforms().getTransform(ItemCameraTransforms.TransformType.GROUND).scale.y;
